...
struct Book {
    ...
    func factsOfBook() {
        print("The title is \(title), the author is \(author), it has \(pages) pages, and it costs $\(price)")
    }
}

var favoriteBook = Book(title: "Ender's Game", author: "Orson Scott Card", pages: 2763, price: 2763.0)
favoriteBook.factsOfBook()
/*:
...
var firstLaptop = Laptop(repairCount: 3, yearPurchased: 2013)
var secondLaptop = Laptop(yearPurchased: 2023)
/*:
...
struct Height {
    ...
    init(centimeters: Double) {
        ...
        heightInInches = centimeters * (1 / 2.54)
    }
}
